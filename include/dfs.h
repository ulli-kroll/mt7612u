...
#ifdef DFS_ATP_SUPPORT
INT Set_DfsAtpStart_Proc(IN Pstruct rtmp_adapter , IN char *);
INT Set_DfsAtpReset_Proc(IN Pstruct rtmp_adapter , IN char *);
INT Set_DfsAtpReport_Proc(IN Pstruct rtmp_adapter , IN char *);
#endif
