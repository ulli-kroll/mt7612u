...
static inline void mt7612u_mcu_inc_error_count(struct mt7612u_mcu_ctrl  *ctl, enum cmd_msg_error_type type)
{
...
static void mt7612u_mcu_queue_init(struct mt7612u_mcu_ctrl  *ctl, DL_LIST *list)
{
