...
void mt76x2_read_tx_alc_info_from_eeprom(struct rtmp_adapter *ad)
{
	...
	e2p_value = mt7612u_read_eeprom16(ad, 0x34);
	/*
	...
	*/
	...
	if ((ePA_type == 0) || (ePA_type == 1)) {
		...
		e2p_value = mt7612u_read_eeprom16(ad, 0xF2);
	...
	if ((ePA_type == 0) || (ePA_type == 2)) {
		...
		e2p_value = mt7612u_read_eeprom16(ad, 0xF4);
		...
		e2p_value = mt7612u_read_eeprom16(ad, 0x52);
