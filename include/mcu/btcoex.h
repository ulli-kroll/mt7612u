...
typedef struct _COEX_MODE_STRUCTURE {
    ...
    u8       RxBAWinLimit; /* 0 = not set, use original value */
    u8       TxBAWinLimit; /* 0 = not set, use origianl value */
...
VOID TDDFDDExclusiveRequest(IN struct rtmp_adapter *pAd, u8 CoexMode);
