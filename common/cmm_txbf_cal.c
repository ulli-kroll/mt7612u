		...
		IN BOOLEAN gBand)
{
	...
	pCR_BK[54] = mt7612u_read32(pAd,CORE_R1);
	pCR_BK[55] = mt7612u_read32(pAd,CORE_R4);
	pCR_BK[56] = mt7612u_read32(pAd,CORE_R33);
	pCR_BK[57] = mt7612u_read32(pAd,DACCLK_EN_DLY_CFG);
	pCR_BK[58] = mt7612u_read32(pAd,TXBE_R1);
	pCR_BK[59] = mt7612u_read32(pAd,TXBE_R5);
	pCR_BK[60] = mt7612u_read32(pAd,TXBE_R6);
	pCR_BK[61] = mt7612u_read32(pAd,AGC1_R0);
	pCR_BK[62] = mt7612u_read32(pAd,CAL_R1);
	pCR_BK[63] = mt7612u_read32(pAd,CAL_R2);
	pCR_BK[64] = mt7612u_read32(pAd,CAL_R5);
	pCR_BK[65] = mt7612u_read32(pAd,PWR_PIN_CFG);
