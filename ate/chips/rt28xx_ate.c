    ...
    IN struct rtmp_adapter *pAd)
{
	...
	uint32_t R2 = 0, R3 = DEFAULT_RF_TX_POWER, R4 = 0;
	...
	if (Channel <= 14)
	{
		uint32_t TxPinCfg = 0x00050F0A;/* 2007.10.09 by Brian : 0x0005050A ==> 0x00050F0A */
	...
	{
	    uint32_t TxPinCfg = 0x00050F05;/* 2007.10.09 by Brian : 0x00050505 ==> 0x00050F05 */
